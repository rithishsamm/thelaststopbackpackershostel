! function(a) {
    ...
    a(window).on("load", function() {
        a('[data-loader="circle-side"]').fadeOut(), a("#preloader").addClass("loaded"), a(".animate_hero").addClass("is-transitioned")
    }), a(window).on("scroll", function() {
        1 < a(this).scrollTop() ? a(".fixed_header").addClass("sticky") : a(".fixed_header").removeClass("sticky")
    }), a(window).scroll(), scrollCue.init({
        percentage: .85
    ...
    var t, i, o, s, n = a(window),
        r = a("#section_video video");
    r.length && (r.each(function() {
        a(this).attr("webkit-playsinline", ""), a(this).attr("playsinline", ""), a(this).attr("muted", "muted"), a(this).attr("id", "loadvideo"), document.getElementById("loadvideo").load()
    }), n.scroll(function() {
        r.each(function() {
            var e;
            1 == (t = a(e = this).offset().top, i = t + a(e).outerHeight(), o = n.scrollTop(), s = o + n.height(), o < i && t < s) ? a(this)[0].play() : a(this)[0].pause()
        })
